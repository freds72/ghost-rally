	...
	for j=2,#p do
		...
		while i<=ground_right do
			...
			if x3>0 then
				...
				local strip=band(ni,2)+band(nj,2)
				c_hi,c_lo=shade(c_hi),shade(c_lo)

				fillp(dither_pat2[strip/2+1])
...
0000000001dc770087000000eeeeeeeeeeeeeeee9aa79000ee7777eeb888856599766666777777777711666667666677777777788756666bb000000007666700
